...
<!-- Mirrored from themesbrand.com/velzon/html-2.5.0/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Apr 2025 00:07:37 GMT -->
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" onclick="logout()" href="#"><i
                                        ...
                                        class="align-middle" data-key="t-logout">Logout <form method="POST"
                                            id="logout-form" action="{{ route('logout') }}"> @csrf </form></span> </a>
                            </div>
                        </div>
                    </div>
                </div>
